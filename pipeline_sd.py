...
model_path = os.path.expanduser("~/data/models/stable-diffusion-v1-5/")
...
prompt = ["a photograph of a sexy cat"]
height = 512  # default height of Stable Diffusion
width = 512  # default width of Stable Diffusion
num_inference_steps = 25  # Number of denoising steps
guidance_scale = 7.5  # Scale for classifier-free guidance
generator = torch.Generator(device="cuda").manual_seed(0)   # Seed generator to create the initial latent noise
...
image.save("sd_generated_image.png")